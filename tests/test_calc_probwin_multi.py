...
class CalcProbwinTestCase(unittest.TestCase):
    ...
    def test_lessthan7(self): 
        with self.assertRaises(ValueError) as er:
            calc_probwin_multi(self.test_lesscards,[])
    ...
    def test_repeating_cards(self):
        with self.assertRaises(ValueError) as er:
            calc_probwin_multi(self.testrep[:2],self.testrep[2:])
    ...
    def test_dif_sim_lookup1(self):
        self.assertTrue(abs(calc_probwin_multi(self.testhand_3ofakind[:2],[],type='lookup')[0]
                        -calc_probwin_multi(self.testhand_3ofakind[:2],[])[0])==0)
        
    def test_dif_sim_lookup2(self):
        self.assertTrue(abs(calc_probwin_multi(self.testhand_3ofakind[:2],[],type='lookup')[0]
                        -calc_probwin_multi(self.testhand_3ofakind[:2],[],type='simul')[0])<0.01)
        
    def test_2card_sim_high(self):
        self.assertTrue(calc_probwin_multi(self.testhand_2high,[],type='simul')[0]
                        >0.8)
        self.assertTrue(0.8>calc_probwin_multi(self.testhand_2high,[],type='simul',n=3)[0]
                        >0.7)
        
    def test_2card_sim_low(self):
        self.assertTrue(calc_probwin_multi(self.testhand_2low,[],type='simul')[0]
                        <0.35)
    ...
    def test_sumprob_n5(self):
        a=calc_probwin_multi(self.testhand_5any[:2], self.testhand_5any[2:],n=5)
        self.assertAlmostEqual(a[0]+a[1]+a[2],1,places=2)
        
    def test_increment_n10(self):
        self.assertTrue(calc_probwin_multi(self.testhand_5any[:2],[],n=2, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=3, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=4, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=5, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=6, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=7, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=8, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=9, type='lookup')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=10, type='lookup'))
        
    
    def test_increment_n10_simul(self):
        self.assertTrue(calc_probwin_multi(self.testhand_5any[:2],[],n=2, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=3, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=4, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=5, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=6, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=7, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=8, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=9, type='simul')>
                        calc_probwin_multi(self.testhand_5any[:2],[],n=10, type='simul'))
